...
"Show me keynote sessions"
"What Power Platform sessions are available?"
```
...
Each setup guide has a **direct link** you can share:

- **Copilot Studio:** `github.com/fabianwilliams/ConferenceHaven-Community/blob/main/docs/setup/COPILOT-STUDIO.md`
- **Claude Desktop:** `github.com/fabianwilliams/ConferenceHaven-Community/blob/main/docs/setup/CLAUDE-DESKTOP.md`
- **ChatGPT Desktop:** `github.com/fabianwilliams/ConferenceHaven-Community/blob/main/docs/setup/CHATGPT.md`
- **LM Studio:** `github.com/fabianwilliams/ConferenceHaven-Community/blob/main/docs/setup/LM-STUDIO.md`

**LinkedIn/Twitter campaign ideas:**
```
...
#Claude #MCP #Conferences
```

---

**Choose your client above to get started! 👆**
